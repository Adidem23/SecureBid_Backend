    ...
    const getProperty = async () =>{
      ...
      for(let i=0; i<_totalIndices; i++){
        ...
        if(ownerOwns[3].words[0] != 0){
            ...
            const UserName=await contract.getUserName(landDetails[0]);

            const landDetails2 = {state: ownerOwns[0], district: ownerOwns[1], city: ownerOwns[2], surveyNo: ownerOwns[3].words[0], isAvaliable,userName:UserName}
